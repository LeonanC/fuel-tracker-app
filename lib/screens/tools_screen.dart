            ...
            body: ListView(
              children: [
                _buildToolCard(
                  context,
                  title: context.tr(
                    TranslationKeys.toolsScreenAppearanceTitle,
                  ),
                  description: context.tr(
                    TranslationKeys.toolsScreenAppearanceDescription,
                  ),
                ...
                _buildToolCard(
                  ...
                  description: context.tr(
                    TranslationKeys.toolsScreenLanguageCardDescription,
                  ),
                  icon: Icons.language,
                  onTap: () {
                    Navigator.push(
                ...
                _buildToolCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UnitSettingsScreen(),
                      ),
                    );
                  },
                ),
                _buildToolCard(
                  context,
                  title: context.tr(
                    TranslationKeys.toolsScreenCurrencyCardTitle,
                  ),
                  description: context.tr(
                    TranslationKeys.toolsScreenCurrencyCardDescription,
                  ),
                ...
                _buildToolCard(
                  ...
                  description: context.tr(
                    TranslationKeys.toolsScreenNotificationCardDescription,
                  ),
                ...
                _buildToolCard(
                  context,
                  title: context.tr(
                    TranslationKeys.toolsScreenExportReportCardTitle,
                  ),
                  description: context.tr(
                    TranslationKeys.toolsScreenExportReportCardDescription,
                  ),
                  icon: Icons.table_chart,
                  onTap: () async {
                    ScaffoldMessenger.of(context).hideCurrentSnackBar();

                    final List<FuelEntry> entries = await fuelProvider
                        .getAllEntriesForExport();
                    final String? errorMessage = await exportService
                        .exportAndShareEntries(entries);
                    ...
                    if (context.mounted) {
                      if (errorMessage != null) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(
                              'Relatório gerado! Escolha como compartilhar.',
                            ),
                ...
                _buildToolCard(
                  context,
                  title: context.tr(
                    TranslationKeys.toolsScreenClearAllDataCardTitle,
                  ),
                  description: context.tr(
                    TranslationKeys.toolsScreenClearAllDataCardDescription,
                  ),
        ...
        return AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                Navigator.of(dialogContext).pop();
                final provider = Provider.of<FuelEntryProvider>(
                  context,
                  listen: false,
                );
