...
class _LanguageSettingsScreenState extends State<LanguageSettingsScreen>
  ...
  TextStyle _getResponsiveStyle(
    ...
    if (isRtl) {
      return GoogleFonts.vazirmatn(fontSize: fontSize, fontWeight: fontWeight, color: color);
    }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [AppTheme.primaryFuelColor, AppTheme.primaryFuelColor.withBlue(200)],
  ...
  Future<void> _changeLanguage(AppLanguage language) async {
    ...
    Get.dialog(
      const Center(child: CircularProgressIndicator(color: AppTheme.primaryFuelColor)),
      ...
      child: ListTile(
        ...
        title: Text(
          ...
          style: GoogleFonts.vazirmatn(
            ...
            color: isSelected ? AppTheme.primaryFuelColor : theme.colorScheme.onSurface,
          ),
        ),
        subtitle: Text(
        ...
        trailing: isSelected
            ? const Icon(Icons.check_circle_rounded, color: AppTheme.primaryFuelColor)
            : Icon(Icons.arrow_forward_ios_rounded, size: 14, color: theme.disabledColor),
      ),
    );
  }
}
