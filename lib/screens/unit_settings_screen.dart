...
class UnitSettingsScreen extends GetView<UnitController> {
          ...
          children: [
            Padding(
              ...
              child: Text(
                ...
                style: theme.textTheme.bodyMedium?.copyWith(color: textColor.withOpacity(0.6)),
              ),
            ),
            _buildRowItem(
  ...
  Widget _buildDropdown<T extends Object>({
    ...
    return DropdownButtonHideUnderline(
      child: DropdownButton<T>(
        ...
        icon: Icon(Icons.keyboard_arrow_down_rounded, color: AppTheme.primaryFuelColor),
        onChanged: onChanged,
  ...
  Widget _buildFontScaleSlider(BuildContext context, ThemeController themeController, Color textColor) {
    return Column(
