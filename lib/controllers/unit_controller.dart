...
class UnitController extends GetxController {
  ...
  Future<void> _loadUnits() async {
    ...
    if (consumptionIndex >= 0 && consumptionIndex < ConsumptionUnit.values.length) {
  ...
  void _saveUnit<T extends Enum>(Rx<T> reactiveUnit, T unit, String key, String unitDescription) {
