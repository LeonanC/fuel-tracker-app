...
class TranslationKeys {
  ...
  static const String navigationSearch = 'navigation.fuel_search';
  ...
  static const String mapSearchCheapestGasStation =
      'map_screen.map_search_cheapest_gas_station';
  static const String mapLocationServiceDisabled =
      'map_screen.map_location_service_disabled';
  static const String mapPermissionDenied = 'map_screen.map_permission_denied';
  static const String mapPermissionDeniedForever =
      'map_screen.map_permission_denied_forever';
  ...
  static const String commonLabelsPricePerLiter =
      'common_labels.price_per_liter';
  static const String commonLabelsGasStation = 'common_labels.gas_station';
  static const String commonLabelsCurrencySymbol =
      'common_labels.currency_symbol';
  ...
  static const String commonLabelsDeleteConfirmation =
      "common_labels.confirmation";
  static const String commonLabelsDeleteConfirmMessage =
      "common_labels.confirm_message";
  ...
  static const String consumptionCardsOverallAverage =
      'consumption_cards.overall_average';
  static const String consumptionCardsNotAvailableShort =
      'consumption_cards.not_available_short';
  static const String consumptionCardsUnitKmPerLiter =
      'consumption_cards.unit_km_l';
  static const String consumptionCardsConsumptionPeriod =
      'consumption_cards.consumption_period';
  ...
  static const String entryScreenLabelPricePerLiter =
      'entry_screen.label_price_per_liter';
  static const String entryScreenLabelTotalPrice =
      'entry_screen.label_total_price';
  static const String entryScreenLabelVeiculos = 'entry_screen.label_veiculos';
  static const String entryScreenLabelGasStation =
      'entry_screen.label_gas_station';
  static const String entryScreenLabelFullTank = 'entry_screen.label_full_tank';
  static const String entryScreenInfoLastOdometerPrefix =
      'entry_screen.info_last_odometer_prefix';
  static const String entryScreenInfoLastOdometerPrefix2 =
      'entry_screen.info_last_odometer_prefix_2';
  static const String entryScreenReceiptAddOptional =
      'entry_screen.receipt_add_optional';
  static const String entryScreenReceiptSelected =
      'entry_screen.receipt_selected';
  static const String entryScreenReceiptPathPrefix =
      'entry_screen.receipt_path_prefix';
  ...
  static const String entryScreenDialogReceiptTitle =
      'entry_screen.dialog_receipt_title';
  ...
  static const String entryScreenErrorOdometerTitle =
      'entry_screen.error_odometer_title';
  static const String entryScreenErrorOdometerMessage =
      'entry_screen.error_odometer_message';

  static const String validation = 'validation';
  static const String validationRequiredOdometer =
      'validation.required_odometer';
  static const String validationOdometerMustBeGreater =
      'validation.odometer_must_be_greater';
  static const String validationRequiredVeiculos =
      'validation.required_veiculos';
  static const String validationRequiredFuelType =
      'validation.required_fuel_type';
  static const String validationRequiredValidLiters =
      'validation.required_valid_liters';
  static const String validationRequiredValidPricePerLiter =
      'validation.required_valid_price_per_liter';
  static const String validationRequiredValidTotalPrice =
      'validation.required_valid_total_price';
  static const String validationPriceInconsistencyAlert =
      'validation.price_inconsistency_alert';
  ...
  static const String toolsScreenAppearanceTitle =
      'tools_screen.appearance_title';
  static const String toolsScreenAppearanceDescription =
      'tools_screen.appearance_description';
  static const String appearanceSettingsTitle =
      'tools_screen.appearance_settings_title';
  ...
  static const String fontSizeSectionTitle =
      'tools_screen.fontSize_section_title';
  ...
  static const String toolsScreenLanguageCardTitle =
      'tools_screen.language_card_title';
  static const String toolsScreenLanguageCardDescription =
      'tools_screen.language_card_description';
  static const String toolsScreenLanguageSnackbarMessage =
      'tools_screen.language_snackbar_message';
  static const String toolsScreenUnitCardTitle = 'tools_screen.unit_card_title';
  static const String toolsScreenUnitCardDescription =
      'tools_screen.unit_card_description';
  static const String toolsScreenCurrencyCardTitle =
      'tools_screen.currency_card_title';
  static const String toolsScreenCurrencyCardDescription =
      'tools_screen.currency_card_description';
  static const String toolsScreenNotificationCardTitle =
      'tools_screen.notification_card_title';
  static const String toolsScreenNotificationCardDescription =
      'tools_screen.notification_card_description';
  static const String toolsScreenExportReportCardTitle =
      'tools_screen.export_report_card_title';
  static const String toolsScreenExportReportCardDescription =
      'tools_screen.export_report_card_description';
  static const String toolsScreenClearAllDataCardTitle =
      'tools_screen.clear_all_data_card_title';
  static const String toolsScreenClearAllDataCardDescription =
      'tools_screen.clear_all_data_card_description';
  static const String toolsScreenGasStationManagementTitle =
      "Gerenciamento de Postos";
  static const String toolsScreenGasStationManagementDescription =
      "Adicione ou edite seus postos favoritos.";
  static const String toolsScreenBackupCardTitle =
      'tools_screen.backup_card_title';
  static const String toolsScreenBackupCardDescription =
      'tools_screen.backup_card_description';
  static const String toolsScreenStatisticsTitle =
      'tools_screen.statistics_title';
  static const String toolsScreenStatisticsDescription =
      'tools_screen.statistics_description';
  static const String toolsScreenFeedbackTitle = 'tools_screen.feedback_title';
  static const String toolsScreenFeedbackDescription =
      'tools_screen.feedback_description';
  ...
  static const String toolsScreenAvgPriceTitle =
      'tools_screen.statistics_monthly_avg_price_title';
  ...
  static const String toolsScreenAverageConsumption =
      'tools_screen.average_consumption';
  static const String toolsScreenAveragePricePerLiter =
      'tools_screen.average_price_per_liter';
  ...
  static const String unitSettingsScreenDistance =
      'unit_settings.distance_unit';
  static const String unitSettingsScreenVolume = 'unit_settings.volume_unit';
  static const String unitSettingsScreenConsumption =
      'unit_settings.consumption_unit';
  ...
  static const String unitSettingsScreenKmPerLiter =
      'unit_settings.km_per_liter';
  static const String unitSettingsScreenLitersPer100km =
      'unit_settings.liters_per_100km';
  ...
  static const String emptyStateMaintenanceMessage =
      "maintenance.empty_message";

  static const String maintenanceFormServiceType =
      "maintenance.form_service_type";
  ...
  static const String maintenanceFormReminderSection =
      "maintenance.form_reminder_section";
  static const String maintenanceFormEnableReminder =
      "maintenance.form_enable_reminder";
  static const String maintenanceFormReminderKm =
      "maintenance.form_reminder_km";
  static const String maintenanceFormReminderDate =
      "maintenance.form_reminder_date";
  static const String maintenanceFormSaveButton =
      "maintenance.form_save_button";

  static const String maintenanceServiceAddNew = 'maintenance.service_add_new';
  static const String maintenanceDialogAddServiceTitle =
      'maintenance.add_service_title';
  static const String maintenanceDialogAddServiceLabel =
      'maintenance.add_service_label';
  static const String maintenanceDialogAddServiceHint =
      'maintenance.add_service_hint';
  static const String maintenanceDialogButtonAdd =
      'maintenance.dialog_button_add';
  static const String maintenanceDialogButtonCancel =
      'maintenance.dialog_button_cancel';
  static const String validationRequiredServiceType =
      'maintenance.validation_required_service';
  static const String maintenanceServiceOilChange =
      "maintenance.service_oil_change";
  static const String maintenanceServiceTireRotation =
      "maintenance.service_tire_rotation";
  static const String maintenanceServiceBrakePads =
      "maintenance.service_brake_pads";
  static const String maintenanceServiceGeneralInspect =
      "maintenance.service_general_inspection";

  static const String fuelTypeGasolineComum = "maintenance.gasoline_comum";
  static const String fuelTypeGasolineAditivada =
      "maintenance.gasoline_aditivada";
  ...
  static const String updateServiceCheckForUpdates =
      "update_service.check_for_updates";
  static const String updateServiceCurrentVersion =
      "update_service.current_version";
  static const String updateServiceNewVersion = "Versão: ";
  ...
  static const String updateServiceNoUpdate =
      "update_service.service_no_update";
  ...
  static const String dialogFilterSelectFilters =
      "dialog_filter.select_filters";
  static const String dialogFilterChartStructureTitle =
      "dialog_filter.chart_structure_title";
  static const String dialogFilterChartStructureBody =
      "dialog_filter.chart_structure_body";
  static const String dialogFilterChartPlaceholder =
      "dialog_filter.chart_placeholder";
  static const String dialogFilterOptionsTitle = "dialog_filter.options_title";
  static const String dialogFilterFuelTypeSuffix =
      "dialog_filter.fuel_type_suffix";
  static const String dialogFilterFilterClearFilter =
      "dialog_filter.filter_clear_filter";
  ...
  static const String gasStationLabelPriceGasoline =
      'gasstation.label_price_gasoline';
  static const String gasStationLabelPriceEthanol =
      'gasstation.label_price_ethanol';
  static const String gasStationLabelConvenienceStore =
      'gasstation.label_convenience_store';
  ...
  static const String gasStationRequiredFieldBrand =
      'gasstation.required_brand';
  static const String gasStationRequiredValidLatitude =
      'gasstation.required_valid_latitude';
  static const String gasStationRequiredValidLongitude =
      'gasstation.required_valid_longitude';
  static const String gasStationRequiredValidPrice =
      'gasstation.required_valid_price';
  static const String gasStationButtonDelete = 'gasstation.button_delete';
  static const String gasStationButtonDeleteSubtitle =
      'gasstation.button_delete_subtitle';
  static const String gasStationButtonDeleteConfirm =
      'gasstation.button_delete_confirm';
  static const String gasStationButtonDeleteCancel =
      'gasstation.button_delete_cancel';
  ...
  static const String desc1 =
      "Registre cada abastecimento para monitorar seu consumo e custo.";
...
class TrHelper {
  ...
  static String versionFormat(String version, {bool isNew = false}) {
    final key = isNew
        ? 'tools_screen.new_version'
        : 'tools_screen.current_version';
